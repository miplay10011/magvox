...
export let selectedSlot = 0, held = null, invOpen = false;
...
let hotbarEl, hudSlots, invEl, invSlots, recycleSlotDiv, recycleBtn;
...
export function initInventory() {
  ...
  if (recycleSlotDiv) {
    recycleSlotDiv.addEventListener('mousedown', (e) => { e.preventDefault(); clickSlot(36, e.button); });
  }
...
export function toggleInventory() {
  ...
  if (invOpen) {
    ...
    keys.clear(); // keys из player.js – нужно импортировать
  } else {
    if (held) {
